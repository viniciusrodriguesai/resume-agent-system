...
st.set_page_config(
    page_title="Resume Match AI V6.0.5",
    page_icon="🧠",
    layout="wide",
...
def main() -> None:
    ...
    st.markdown(
        """
        <div class="hero">
          <div><span class="eyebrow">V6.0.5 · LOCAL · CÓDIGO ABERTO</span><h1>IA de Correspondência de Currículos</h1><p>Plataforma multiagente para comparar currículos e vagas com evidências, privacidade e explicabilidade.</p></div>
