...
SKILLS: dict[str, tuple[str, list[str]]] = {
    ...
    "GitHub Actions": ("devops", ["github actions", "github action"]),
    "CI/CD": ("devops", ["ci/cd", "cicd", "continuous integration", "continuous delivery"]),
    "Docker": ("devops", ["docker", "container"]),
    "Kubernetes": ("devops", ["kubernetes", "k8s"]),
    "Terraform": ("devops", ["terraform"]),
    "Pulumi": ("devops", ["pulumi"]),
    "CloudFormation": ("devops", ["cloudformation", "aws cloudformation"]),
    "Linux": ("devops", ["linux"]),
    ...
    "RabbitMQ": ("mensageria", ["rabbitmq", "rabbit mq"]),
    "Apache Kafka": ("mensageria", ["apache kafka", "kafka"]),
    "Prometheus": ("observabilidade", ["prometheus"]),
    "Grafana": ("observabilidade", ["grafana"]),
